...
import br.com.erudio.authenticator.R;

import static br.com.erudio.authenticator.authentication.AccountGeneral.sServerAuthenticate;
import static br.com.erudio.authenticator.authentication.AuthenticatorActivity.ARG_ACCOUNT_TYPE;
import static br.com.erudio.authenticator.authentication.AuthenticatorActivity.KEY_ERROR_MESSAGE;
import static br.com.erudio.authenticator.authentication.AuthenticatorActivity.PARAM_USER_PASS;
    ...
    private void createAccount() {
        ...
        new AsyncTask<String, Void, Intent>() {
            ...
            protected Intent doInBackground(String... params) {
                ...
                Log.d("Erudio", TAG + "> Started authenticating");
