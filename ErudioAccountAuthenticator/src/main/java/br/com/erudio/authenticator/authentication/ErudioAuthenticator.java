...
public class ErudioAuthenticator extends AbstractAccountAuthenticator {
    ...
    public ErudioAuthenticator(Context context) {
        super(context);
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response, Account account, String authTokenType, Bundle options) throws NetworkErrorException {
        ...
        Log.d("Erudio", TAG + "> peekAuthToken returned - " + authToken);
        ...
        if (TextUtils.isEmpty(authToken)) {
            ...
            if (password != null) {
                try {
                    Log.d("Erudio", TAG + "> re-authenticating with the existing password");
